...
- (id)initWithModel:(id)arg1 version:(id)arg2 viewList:(id)arg3 priorityViews:(id)arg4 userControllableViews:(id)arg5 syncUserControllableViews:(int)arg6 viewsToPiggybackTLKs:(id)arg7 keyViewMapping:(id)arg8;
