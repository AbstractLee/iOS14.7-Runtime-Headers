...
+ (id)policyWithModelToCategory:(id)arg1 categoriesByView:(id)arg2 introducersByCategory:(id)arg3 keyViewMapping:(id)arg4 unknownRedactions:(bool)arg5 userControllableViewList:(id)arg6 piggybackViews:(id)arg7 priorityViews:(id)arg8 version:(id)arg9;
