...
@property (nonatomic) unsigned long long pendingWaitForReadyToPlaySignpostIdentifier;
...
- (unsigned long long)pendingWaitForReadyToPlaySignpostIdentifier;
...
- (void)setPendingWaitForReadyToPlaySignpostIdentifier:(unsigned long long)arg1;
