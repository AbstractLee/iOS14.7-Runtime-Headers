...
@interface COMeshController : NSObject <COMeshNodeDelegate, COMeshNodeStateTrackerDelegate> {
    ...
    id /* block */  _controlFlagsProvider;
...
@property (nonatomic, copy) id /* block */ controlFlagsProvider;
...
- (void)_finalizeCompletionOfNode:(id)arg1 eventProvider:(id /* block */)arg2;
...
- (void)setControlFlagsProvider:(id /* block */)arg1;
