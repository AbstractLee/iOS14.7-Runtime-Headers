...
@interface CSBuiltInVoiceTrigger : NSObject <CSActivationEventNotificationHandlerDelegate, CSAudioRouteChangeMonitorDelegate, CSAudioServerCrashMonitorDelegate, CSAudioStreamProvidingDelegate, CSBluetoothWirelessSplitterMonitorDelegate, CSFirstPassResultsProviding, CSKeywordAnalyzerNDAPIScoreDelegate, CSPhoneCallStateMonitorDelegate, CSSecondPassProgressProviding, CSSelfTriggerDetectorDelegate, CSSiriClientBehaviorMonitorDelegate, CSStateMachineDelegate, CSVoiceTriggerXPCServiceProxyDelegate> {
...
- (void)_clearFirstPassVoiceTriggerSignalEstimate;
...
- (void)fetchFirstPassSignalEstimate:(id /* block */)arg1;
- (void)fetchSecondPassState:(id /* block */)arg1;
