...
@interface CSPreMyriadCoordinator : NSObject <CSVoiceTriggerDelegate> {
    <CSFirstPassResultsProviding><CSSecondPassProgressProviding> * _builtInSeconPassProgressProvider;
...
@property (nonatomic) <CSFirstPassResultsProviding><CSSecondPassProgressProviding> *builtInSeconPassProgressProvider;
