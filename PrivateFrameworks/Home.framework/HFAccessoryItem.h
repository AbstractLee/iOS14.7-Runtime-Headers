...
@interface HFAccessoryItem : HFItem <HFActionBuilderFactory, HFCompoundItemProtocol, HFGroupableItemProtocol, HFMediaAccessoryProtocol, HFServiceLikeBuilderCreating, HFServiceLikeItem> {
