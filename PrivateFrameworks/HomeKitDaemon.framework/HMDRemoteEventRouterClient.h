...
@interface HMDRemoteEventRouterClient : NSObject <HMEMessageDatagramClientDataSource, HMEMessageDatagramClientDelegate, HMFLogging, HMFMessageReceiver> {
    ...
    bool  _lastServerResponseIndicatesCompressionCapable;
...
@property (nonatomic) bool lastServerResponseIndicatesCompressionCapable;
...
- (bool)_serverSupportsCompression:(id)arg1;
- (id)_underlyingMessageDataIfFragmentedMessageData:(id)arg1 error:(id*)arg2;
...
- (bool)lastServerResponseIndicatesCompressionCapable;
- (id)logIdentifier;
...
- (void)setLastServerResponseIndicatesCompressionCapable:(bool)arg1;
