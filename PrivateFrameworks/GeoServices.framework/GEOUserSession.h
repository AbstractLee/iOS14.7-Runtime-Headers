...
- (void).cxx_destruct;
- (void)_changeStartDateIfInSessionIDData:(id)arg1;
- (void)_create15MonthSessionFirstTime:(bool)arg1;
- (void)_createLongSessionWithOffset:(bool)arg1;
- (void)_downloadCatalogThen:(id /* block */)arg1;
- (void)_downloadIDListForPolygonType:(id)arg1 formatVersion:(id)arg2 then:(id /* block */)arg3;
- (void)_generateNewNavSessionID;
- (double)_getCurrentTime;
- (unsigned long long)_nextFirstUseDataSetID;
...
- (void)_removeSessionIDIfInSessionIDFile:(id)arg1;
...
- (void)_startMapsFirstUseDateCorrection;
