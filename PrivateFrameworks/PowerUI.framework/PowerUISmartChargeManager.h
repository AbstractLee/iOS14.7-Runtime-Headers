...
@interface PowerUISmartChargeManager : NSObject <ACCConnectionInfoDelegateProtocol, NSXPCListenerDelegate, PowerUISignalMonitorDelegate, PowerUISmartChargeManaging, PowerUISmartChargeManagingPrivate, UNUserNotificationCenterDelegate> {
